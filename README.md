...
```bash
$ npm i mariadb mysql @nestjs/config apollo-server-express
```
...
if appears in the terminal the follow message:
...
https://stackoverflow.com/questions/64788443/nestjs-hot-module-replacement-invalid-options-object
